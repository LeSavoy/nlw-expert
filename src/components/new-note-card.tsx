...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  function heandleContentChanged(event: ChangeEvent<HTMLTextAreaElement>) {
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          className="fixed overflow-hidden inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2
                                   md:max-w-[640px] w-full bg-slate-700 md:rounded-md flex flex-col otline-none md:h-[60vh]"
        >
            ...
            <div className="flex flex-1 flex-col gap-3 p-5">
              ...
              {shouldShowOnBoarding ? (
                ...
                <textarea
                  ...
                  onChange={heandleContentChanged}
                  value={content}
                ></textarea>
              )}
            </div>
